      ...
      2: [
        function (e, t, n) {
          ...
          function o(e) {
            e.addEventListener("submit", u),
              (e.onmouseenter = function () {
                var e = h(this),
                  t = this.querySelector("[name=score]");
                if (t) {
                  var n = i.findParent(this, "star-ratings");
                  n.querySelector(
                    ".star-ratings-rating-foreground"
                  ).style.width = (100 / e) * t.value + "%";
                }
              }),
              (e.onmouseleave = function () {
                var e = p(this),
                  ...
                  r = (100 / t) * e + "%";
                n.querySelector(".star-ratings-rating-foreground").style.width =
                  r;
              });
          }
          function u(e) {
          ...
          function d(e, t) {
            ...
            if (s) {
              r = s.getElementsByClassName("star-ratings-rating-value")[0];
              if (r) {
                var o = e.average.toFixed(2);
                e.average === 0 && (o = 0), (r.innerHTML = o);
              }
            }
            var u = n.getElementsByClassName("star-ratings-rating-count")[0];
            u &&
              ((r = u.getElementsByClassName("star-ratings-rating-value")[0]),
              r && (r.innerHTML = e.count));
            var a = n.getElementsByClassName("star-ratings-rating-user")[0],
              f = n.getElementsByClassName("star-ratings-clear")[0];
            a &&
              ((r = a.getElementsByClassName("star-ratings-rating-value")[0]),
              r &&
                (e.user_rating == null && r.getAttribute("data-when-null", !1)
                  ? ((e.user_rating = r.getAttribute("data-when-null")),
                    f &&
                      (f.classList.remove("star-ratings-clear-visible"),
                      f.classList.add("star-ratings-clear-hidden")))
                  : f &&
                    (f.classList.remove("star-ratings-clear-hidden"),
                    f.classList.add("star-ratings-clear-visible")),
                (r.innerHTML = e.user_rating))),
              (n.querySelector(".star-ratings-rating-foreground").style.width =
                e.percentage + "%");
          }
          function v(e, t) {
        ...
        function (e, t, n) {
          ...
          var r = {
              ...
              return (
                ...
                (i.onreadystatechange = function () {
                  ...
                  i.status >= 200 && i.status <= 299
                    ? n &&
                      (i.responseText ? n(JSON.parse(i.responseText)) : n())
                    : r && r(JSON.parse(i.responseText));
                }),
                i
              );
            },
            ...
            post: function (e, t, n, r) {
              ...
              (i = this.setCSRFToken(i)), i.send(JSON.stringify(t));
            },
